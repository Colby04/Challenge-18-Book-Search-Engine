...
var typeDefs = (0, apollo_server_express_2.gql)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  type Query {\n    hello: String\n  }\n"], ["\n  type Query {\n    hello: String\n  }\n"])));
var resolvers = {
    Query: {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        app.listen({ port: 3001 }, function () {
                            return console.log("Server ready at http://localhost:3001".concat(server.graphqlPath));
                        });
                        return [2 /*return*/];
                }
            });
