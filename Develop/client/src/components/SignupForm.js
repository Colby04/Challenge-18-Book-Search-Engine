...
var SignupForm = function (_a) {
    ...
    var _b = (0, react_1.useState)({ username: '', email: '', password: '', savedBooks: [] }), userFormData = _b[0], setUserFormData = _b[1];
    ...
    var handleFormSubmit = function (event) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, (0, API_1.createUser)(userFormData)];
                case 2:
                    response = _a.sent();
                    if (!response.ok) {
    ...
    return (<>
      ...
      <react_bootstrap_1.Form noValidate validated={validated} onSubmit={handleFormSubmit}>
        ...
        <react_bootstrap_1.Alert dismissible onClose={function () { return setShowAlert(false); }} show={showAlert} variant='danger'>
